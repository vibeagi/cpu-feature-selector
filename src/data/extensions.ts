...
export const EXTENSIONS: Extension[] = [
  ...
  { id: 'ext_zvks', name: 'Zvks 组合', category: 'crypto-vector', description: 'Vector crypto ShangMi suite composite (zksed+zvksh+zvkb+zvkt)', supportedSeries: ['nuclei-600-series', 'nuclei-900-series', 'nuclei-1000-series'], type: 'standard', isComposite: true, components: ['zksed', 'zvksh', 'zvkb', 'zvkt'] },
  ...
  { id: 'zvknhb', name: 'Zvknhb', category: 'crypto-vector', description: 'NIST Suite: Vector SHA-2 Secure Hash (SHA-256 and SHA-512) (requires Vector >= zve64x)', supportedSeries: ['nuclei-600-series', 'nuclei-900-series', 'nuclei-1000-series'], type: 'standard' },
