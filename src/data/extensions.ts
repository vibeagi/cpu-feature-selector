...
export const EXTENSIONS: Extension[] = [
  ...
  { id: 'zfh', name: 'Zfh', category: 'float', description: 'Standard Half-Precision Floating-Point (includes Zfhmin)', supportedSeries: ['nuclei-300-series', 'nuclei-600-series', 'nuclei-900-series', 'nuclei-1000-series'], dependsOnArch: ['f'], dependsOnExtensions: ['zfhmin'], type: 'standard' },
  ...
  { id: 'ext_zdinx', name: 'Zdinx', category: 'float-int', description: 'Double-precision float in integer registers (includes Zfinx)', supportedSeries: ['nuclei-300-series', 'nuclei-600-series', 'nuclei-900-series'], type: 'standard' },
  { id: 'ext_zhinx', name: 'Zhinx', category: 'float-int', description: 'Half-precision float in integer registers (includes Zfinx+Zhinxmin)', supportedSeries: ['nuclei-300-series', 'nuclei-600-series', 'nuclei-900-series'], type: 'standard' },
  { id: 'zhinxmin', name: 'Zhinxmin', category: 'float-int', description: 'Minimal half-precision float in integer registers (includes Zfinx)', supportedSeries: ['nuclei-300-series', 'nuclei-600-series', 'nuclei-900-series'], type: 'standard' },
